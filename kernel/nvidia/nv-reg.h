 ...
 *  1 = use request_threaded_irq to set up the interrupt handler
 */
 ...
 * devtools.
 *
 * Note: this is treated as a hint. MemOPs may still be left disabled by CUDA driver
 * for other reasons, e.g. on MS Win WDDM, etc.
 *
 * Possible Values:
 *
 *  0 = leave feature disabled
 *  1 = enable feature
 */
