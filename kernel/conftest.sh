      ...
      pci_dma_mapping_error)
        ...
        drm_atomic_available)
            ...
            void conftest_drm_atomic_modeset_available(void) {
                ...
                /* 2014-10-27 144ecb97cd57d2a61cc455730a3337e413499cae */
                funcs.atomic_duplicate_state = NULL;

                /* 2014-11-03 d461701c551efe92893b31d05906d51e2f1f8244 */
                (void)drm_atomic_helper_set_config;

                /* 2014-11-05 c2fcd274bce521cd824d96d7f26dfa57ea06478c */
                (void)drm_atomic_helper_swap_state;
        ...
        drm_init_functions_have_name_arg)
            ...
            compile_check_conftest "$CODE" "NV_DRM_INIT_FUNCTIONS_HAVE_NAME_ARG" "" "types"
        ;;
...
case "$6" in
    ...
    cc_version_check)
        ...
        kernel_compile_h=$HEADERS/generated/compile.h
